...
class Public(models.Model):
    ...
    correo_pblc = models.CharField(max_length=50, null=False)
    telefono_pblc = models.IntegerField(null=True)
    rol_pblc = models.IntegerField(null=False)
    contrasena_pblc = models.CharField(max_length=12, null=False)
...
class PQRS(models.Model):
    ...
    nombre_pqrs = models.CharField(max_length=30, null=False)
    apellido_pqrs = models.CharField(max_length=30, null=False)
    correo_pqrs = models.CharField(max_length=50, null=False)
    telefono_pqrs = models.IntegerField(null=True)
    rol_pqrs = models.IntegerField(null=False)
    contrasena_pqrs = models.CharField(max_length=12, null=False)
    fec_creacion_pqrs = models.DateTimeField(auto_now_add=True, null=True)
    class meta:
        db_table = 'PQRS'
